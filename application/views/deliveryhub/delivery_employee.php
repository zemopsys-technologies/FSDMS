...
<div class="row">
        <div class="col-md-6" align ="right">
           <a class="btn btn-sm btn-outline-danger" href="<?php echo base_url()."deliveryhub/view_employee" ?>"> Manage</a> 
        </div>
        <div class="col-md-6" align="right">
...
<div class="col-md-2">
    ...
    <div class = "col-md-11 container">
        <div class="card bg-light text-dark">
            ...
            <p class = "h3">Delivery Employee</p>
                <br>
        <form method="post" action="<?php echo base_url()."Deliveryhub/delivery_emploee_data" ?>">
        <div class="row"> 
         
            <div class="col-md-3">
                <label>Delivery Id</label>
				<input type="text" name="txtkitchen_id" class="form-control" placeholder="" value="" >
            </div>
            <div class="col-md-3">
                <label>Employee Id</label>
				<input type="text" name="txtemp_id" class="form-control" placeholder="" value="">
            </div>
            <div class="col-md-3">
            	<label> First Name</label>
				<input type="text" class="form-control" name="txtemp_name" id="password" placeholder="" value="">
			</div>
...
if(isset($delivery_emp_data))
    {
        ...
        foreach($delivery_emp_data->result() as $kitchen)
    {
        ?>
        <section>
<div class="row">
        ...
        <div class="col-md-6" align="right">
        <a class="btn btn-sm btn-outline-danger" href="<?php echo base_url()."deliveryhub/view_employee" ?>"> Back</a>
        </div>
    </div>
...
<div class="col-md-2">
    ...
    <div class = "col-md-11 container">
        <div class="card bg-light text-dark">
            ...
            <p class = "h3">Edit Delivery Employee</p>
                <br>
        <form method="post" action="<?php echo base_url()."deliveryhub/update_employee" ?>">
        <div class="row"> 
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="txtkitchen_id" class="form-control" placeholder="" value="<?php echo  $kitchen->del_id;?>" readonly>
            </div>
            <div class="col-md-3">
                <label>Employee Id</label>
