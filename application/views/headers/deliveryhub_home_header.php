   ...
   <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
             <li class="nav-item">
              <a class="nav-link disabled" href="#">Hello, <?php echo $this->session->userdata('delivery_user_name'); ?></a>
            </li>
            ...
            <div class="dropdown">
              <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><li class="fa fa-user"></li> User Account</button>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <a class="dropdown-item" href="#"> <li class="fa fa-address-card"></li> Kitchen Profile</a>
                  <a class="dropdown-item" href="#"> <li class="fa fa-address-card"></li> Change Password</a>
...
<div id="accordion">
      ...
      <div id="collapseFour" class="collapse show" data-parent="#accordion">
            ...
            <a href="#submenu2" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
               ...
               <a href="<?php echo base_url()."kitchen/kitchen_stock"?>" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                    <div class="d-flex w-100 justify-content-start align-items-center">
    ...
    <div class="card bg-secondary">
      ...
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
                     ...
                     <a href="<?php echo base_url(); ?>kitchen/kitchen_order_schedule" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                    <div class="d-flex w-100 justify-content-start align-items-center">
