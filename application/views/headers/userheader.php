      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <div class="dropdown-divider"></div>
            ...
            <?php 
              $quantity_count = 0;
              foreach ($this->cart->contents() as $get_quant) 
              {
                $quantity_count = $quantity_count + $get_quant['qty'];
              }
            ?>
            <a class="btn btn-info badge2"  data-badge="<?php echo $quantity_count; ?>" href = "<?php echo base_url()."cart"; ?>" title="Cart"> <li class="fa fa-shopping-cart"></li> </a>&nbsp;&nbsp;&nbsp;<br>
