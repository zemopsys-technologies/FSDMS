...
<script src="https://code.jquery.com/jquery-3.2.1.js" integrity="sha256-DZAnKJ/6XZ9si04Hgrsxu/8s717jcIzLy3oi35EouyE="crossorigin="anonymous"></script>   
  ...
  <body  style="padding-top: 5rem;">
   <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="<?php echo base_url()."kitchen/kitchen_home"?>">FSDMS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
             <li class="nav-item">
              <a class="nav-link disabled" href="#">Hello, <?php echo $this->session->userdata('kitchen_user_name'); ?></a>
            </li>
            <li class="nav-item">
              <a class="nav-link disabled" href="#"> Kitchen ID : <?php echo $this->session->userdata('kitchen_id'); ?>  </a>
            </li>
            <li class="nav-item">
              <a class="nav-link disabled" href="#"> Kitchen Type : <?php echo $this->session->userdata('kitchen_type'); ?>  </a>
            </li>
          </ul>
          <form method="post" class="form-inline mt-2 mt-md-0" action="#">
            ...
            <div class="dropdown">
              <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><li class="fa fa-user"></li> User Account</button>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <a class="dropdown-item" href="<?php echo base_url()."kitchen/profile/".base64_encode($this->session->userdata('id')); ?>"> <li class="fa fa-address-card"></li> User Profile</a>

                  <a class="dropdown-item" href="<?php echo base_url()."kitchen/kitchen_profile" ?>"> <li class="fa fa-address-card"></li> Kitchen Profile</a>
                  <a class="dropdown-item" href="<?php echo base_url()."kitchen/change_profile/".base64_encode($this->session->userdata('id')); ?>"> <li class="fa fa-key"></li> Change Password</a>
            ...
            <a class="btn btn-danger" href = "<?php echo base_url()."kitchen/logout" ?>" title="Logout"><li class="fa fa-sign-out-alt"></li> </a>
          </form>
        </div>
      </nav>
      <!-- END OF NAV -->
...
<div id="accordion">
      ...
      <div id="collapseFour" class="collapse show" data-parent="#accordion">
               ...
               <a href="<?php echo base_url()."kitchen/kitchen_home"?>" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
            ...
            <a href="#submenu2" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
               ...
               <div id='submenu2' class="collapse sidebar-submenu">
                <a href="<?php echo base_url()."kitchen/view_employee"?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Create Employee</span>
                </a>
                <a href="<?php echo base_url()."kitchen/create_emp_role"?>" class="list-group-item list-group-item-action bg-dark text-white">
               ...
               <div id='submenu3' class="collapse sidebar-submenu">
                <a href="<?php echo base_url()."kitchen/kitchen_stock"?>" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Deduct Quantity</span>
                </a>
                <a href="<?php echo base_url()."kitchen/kitchen_dc"?>" class="list-group-item list-group-item-action bg-dark text-white">
            ...
            <!-- <a href="#" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
               ...
               <a href="<?php echo base_url()."kitchen/kitchen_attendance"?>" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                    <div class="d-flex w-100 justify-content-start align-items-center">
    ...
    <div class="card bg-secondary">
      ...
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
                     ...
                     <a href="<?php echo base_url()."kitchen/kitchen_delivery_report"?>" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                    <div class="d-flex w-100 justify-content-start align-items-center">
                         <li class="fas fa-fw mr-3 fa fa-list-alt text-light"></li> 
                         <span class="menu-collapsed text-light"> Order Schedule </span>
                    </div>
               </a>
                    </div>
           <!-- Submenu content 
