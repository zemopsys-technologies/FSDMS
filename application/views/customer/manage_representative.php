<div class="col-sm-6 col-md-10">
  <div class="row">
    ...
    <div class="col-md-6" align="right">
      <a class="btn btn-sm btn-outline-danger" href="<?php echo base_url()."superadmin/corporate_representative"; ?>"> Back</a>
    </div>
  </div><br>
      ...
      <tbody align="center">
        <?php
          ...
          <tr>
            ...
            <td> <a class="btn btn-sm btn-primary" href="<?php echo base_url()."superadmin/edit_representative/".$represent->id; ?>"> Edit </a> </td>
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".delete_category").click(function(){
			...
			{
				window.location="<?php echo base_url();?>superadmin/delete_corp_repres/"+id;
			}
			else
			{
				return false;
