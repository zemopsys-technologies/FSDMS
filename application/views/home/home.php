    				...
    				<div class="card-body">
      				...
      				<div id="accordion<?php echo $accordian_count; ?>">
							...
							?>
												...
												<div class="row">
												  	<div class="col-md-6">
    														<input type="checkbox" class="form-control checked" id="options<?php echo $x; ?>" name="options<?php echo $x; ?>" value="<?php echo $get_products[$x]."/".$get_prices[$x]."/".$get_sku[$x]; ?>" rel="quantity_<?php echo $products->sku.$x; ?>">												  		
												  	</div>
												  	<div class="col-md-6">
 							...
 							?>
								    ...
								    <div class="row">
								    	<div class="col-md-6" align="left">
      										<button class="btn btn-primary add-cart" data-productname="<?php echo $products->name; ?>" data-price="<?php echo $products->price; ?>" data-productid="<?php echo $products->sku; ?>" data-customflag = "<?php if(($products->custom_product != "") && ($products->custom_product_price != "")){echo "1";}else{echo "0";} ?>"> Add To Cart</button>							    		
								    	</div>
